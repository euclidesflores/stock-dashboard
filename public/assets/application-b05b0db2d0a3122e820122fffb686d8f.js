...
//# sourceMappingURL=/assets/basket.min.map
;
...
provide("util/twitter",function(e){using("util/querystring",function(t){function u(e){return typeof e=="string"&&n.test(e)&&RegExp.$1.length<=20}function a(e){if(u(e))return RegExp.$1}function f(e){var n=t.decodeURL(e);n.screen_name=a(e);if(n.screen_name)return t.url("https://twitter.com/intent/user",n)}function l(e){return typeof e=="string"&&o.test(e)}function c(e,t){t=t===undefined?!0:t;if(l(e))return(t?"#":"")+RegExp.$1}function h(e){return typeof e=="string"&&r.test(e)}function p(e){return h(e)&&RegExp.$1}function d(e){return i.test(e)}function v(e){return s.test(e)}var n=/(?:^|(?:https?\:)?\/\/(?:www\.)?twitter\.com(?:\:\d+)?(?:\/intent\/(?:follow|user)\/?\?screen_name=|(?:\/#!)?\/))@?([\w]+)(?:\?|&|$)/i,r=/(?:^|(?:https?\:)?\/\/(?:www\.)?twitter\.com(?:\:\d+)?\/(?:#!\/)?[\w_]+\/status(?:es)?\/)(\d+)/i,i=/^http(s?):\/\/((www\.)?)twitter\.com\//,s=/^http(s?):\/\/pbs\.twimg\.com\//,o=/^#?([^.,<>!\s\/#\-\(\)\'\"]+)$/;e({isHashTag:l,hashTag:c,isScreenName:u,screenName:a,isStatus:h,status:p,intentForProfileURL:f,isTwitterURL:d,isTwimgURL:v,regexen:{profile:n}})})});
...
!function(){window.twttr=window.twttr||{},twttr.host=twttr.host||"platform.twitter.com",using("util/domready","util/env",function(e,t){function n(e){return(e||!/^http\:$/.test(window.location.protocol))&&!twttr.ignoreSSL?"https":"http"}if(t.ie6())return;if(twttr.widgets&&twttr.widgets.loaded)return twttr.widgets.load(),!1;if(twttr.init)return!1;twttr.init=!0,twttr._e=twttr._e||[],twttr.ready=twttr.ready||function(e){twttr.widgets&&twttr.widgets.loaded?e(twttr):twttr._e.push(e)},using.path.length||(using.path=n()+"://"+twttr.host+"/js"),twttr.ignoreSSL=twttr.ignoreSSL||!1;var r=[];twttr.events={bind:function(e,t){return r.push([e,t])}},e(function(){using("tfw/widget/base","tfw/widget/follow","tfw/widget/tweetbutton","tfw/widget/embed","tfw/widget/timeline","tfw/widget/intent","tfw/factories","tfw/util/article","util/events","util/util",function(e,t,i,s,o,u,a,f,l,c){function v(e){var t=twttr.host;return n(e)=="https"&&twttr.secureHost&&(t=twttr.secureHost),n(e)+"://"+t}function m(){using("tfw/hub/client",function(e){twttr.events.hub=e.init(h),e.init(h,!0)})}var h={widgets:{"a.twitter-share-button":i,"a.twitter-mention-button":i,"a.twitter-hashtag-button":i,"a.twitter-follow-button":t,"blockquote.twitter-tweet":s,"a.twitter-timeline":o,"div.twitter-timeline":o,body:u}},p=twttr.events&&twttr.events.hub?twttr.events:{},d;h.assetUrl=v,twttr.widgets=twttr.widgets||{},c.aug(twttr.widgets,a,{config:{assetUrl:v},load:function(t){e.init(h),e.embed(t),twttr.widgets.loaded=!0}}),c.aug(twttr.events,p,l.Emitter),d=twttr.events.bind,twttr.events.bind=function(e,t){m(),this.bind=d,this.bind(e,t)},c.forEach(r,function(e){twttr.events.bind(e[0],e[1])}),c.forEach(twttr._e,function(e){c.async(function(){e(twttr)})}),twttr.ready=function(e){c.async(function(){e(twttr)})},twttr.widgets.load()})})})}()});
(function() {
  ...
  $(document).ready(function() {
    return StockDashboard.initialize();
  });

}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["dashboards/index"] = function(__obj) {
    if (!__obj) __obj = {};
...
(function() { this.JST || (this.JST = {}); this.JST["dashboards/stock"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div class="panel panel-primary">\n\t<div class="panel-heading">');
      
        __out.push(__sanitize(this.model.get('name')));
      
        __out.push('</div>\n\t\t<table class="table">\n\t\t\t<tbody>\n\t\t\t\t<tr><td colspan="2">');
      
        __out.push(__sanitize(this.model.get('stockExchangeInfo')));
      
        __out.push('</td></tr>\n\t\t\t\t<tr><td>Price</td><td style=\'text-align:right\'>$');
      
        __out.push(__sanitize(this.model.get('price')));
      
        __out.push('</td>\n\t\t\t\t<tr><td>Previous close</td><td style=\'text-align:right\'>$');
      
        __out.push(__sanitize(this.model.get('previousClose')));
      
        __out.push('</td>\n\t\t\t\t\t<tr><td>Change</td>\n\t\t\t\t\t\t');
      
        if (this.model.get('change') > 0) {
        ...
        __out.push(__sanitize(this.model.get('change') + ' (' + this.model.get('changePercent') + ')'));
      
        __out.push('</td>\n\n\t\t\t\t</tr>\n\t\t\t\t<tr><td>Volume</td><td style=\'text-align:right\'>');
      
        __out.push(__sanitize(this.model.get('volume')));
      
        __out.push('</td>\n\t\t\t\t<tr><td>Open</td><td style=\'text-align:right\'>$');
      
        __out.push(__sanitize(this.model.get('open')));
      
        __out.push('</td>\n\t\t\t\t<tr><td>High</td><td style=\'text-align:right\'>$');
      
        __out.push(__sanitize(this.model.get('high')));
      
        __out.push('</td>\n\t\t\t\t<tr><td>Low</td><td style=\'text-align:right\'>$');
      
        __out.push(__sanitize(this.model.get('low')));
      
        __out.push('</td>\n\t\t\t\t<tr><td>Avg daily vol</td><td style=\'text-align:right\'>');
      
        __out.push(__sanitize(this.model.get('avgDlyVol')));
      
        __out.push('</td>\n\t\t\t\t<tr><td>Market cap</td><td style=\'text-align:right\'>');
      
        __out.push(__sanitize(this.model.get('marketCap')));
...
(function() { this.JST || (this.JST = {}); this.JST["dashboards/tweets"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          model = _ref[_i];
          __out.push('\n\t<li class="list-group-item">\n\t<blockquote class="twitter-tweet" align="center"><p>');
          __out.push(model.get('text'));
          __out.push('</p>&mdash; ');
          __out.push(model.get('name_tag') + ' ' + model.get('screen_name_tag'));
          __out.push(' <a href="');
          __out.push(__sanitize('https://twitter.com/' + model.get('screen_name') + '/statuses/' + model.get('id')));
          __out.push('" data-datetime=');
          __out.push(__sanitize(model.get('created_at')));
          __out.push('>');
          __out.push(__sanitize(model.get('date_tz')));
          __out.push('</a></blockquote>\n\t</li>\n');
        }
...
(function() {
  ...
  StockDashboard.Models.Dashboard = (function(_super) {
...
(function() {
  ...
  StockDashboard.Models.Stock = (function(_super) {
    ...
    Stock.prototype.defaults = function() {
      return {
        "name": "",
        "stockExchangeInfo": "",
        "symbol": "",
    ...
    Stock.prototype.initialize = function() {
      return this.symbol = $('#stockSymbolTxt').val();
    };

    Stock.prototype.url = function() {
      var data, nurl;
    ...
    Stock.prototype.updateAttributes = function(response) {
      var dtf, rawData;
      rawData = response.query.results.quote;
      this.set("name", rawData.Name);
      this.set("symbol", rawData.Symbol);
      this.set("lastTradeDate", rawData.LastTradeDate);
      this.set("lastTradeTime", rawData.LastTradeTime);
      dtf = this.getLastTradeDateTime(this.get('lastTradeDate'), this.get('lastTradeTime'));
      this.set("stockExchangeInfo", rawData.StockExchange + ': ' + rawData.Symbol + ' - ' + dtf);
      this.set("price", (rawData.AskRealTime === null ? '0.00' : parseFloat(rawData.AskRealtime).toFixed(2)));
      this.set("change", parseFloat(rawData.ChangeRealtime).toFixed(2));
      this.set("changePercent", this.getChangePercentRealtime(rawData.ChangePercentRealtime));
      this.set("volume", parseInt(rawData.Volume).toLocaleString());
      this.set("open", (rawData.Open === null ? '0.00' : parseFloat(rawData.Open).toFixed(2)));
      this.set("previousClose", (rawData.PreviousClose === null ? '0.00' : parseFloat(rawData.PreviousClose).toFixed(2)));
      this.set("high", (rawData.DaysHigh === null ? '0.00' : parseFloat(rawData.DaysHigh).toFixed(2)));
      this.set("low", (rawData.DaysLow === null ? '0.00' : parseFloat(rawData.DaysLow).toFixed(2)));
      this.set("avgDlyVol", (rawData.AverageDailyVolumne === null ? '0.00' : parseInt(rawData.AverageDailyVolume).toLocaleString()));
      this.set("marketCap", rawData.MarketCapitalization);
      return this.trigger('updateTweetsEvent', this);
    };

    Stock.prototype.getLastTradeDateTime = function(lastTradeDate, lastTradeTime) {
      var dt, dtStr, monthNames;
    ...
    Stock.prototype.getChangePercentRealtime = function(changePercent) {
...
(function() {
  ...
  StockDashboard.Models.Tweet = (function(_super) {
    ...
    Tweet.prototype.defaults = function() {
      return {
        "id": "",
    ...
    Tweet.prototype.initialize = function() {
      var created_at_tz;
      created_at_tz = new Date(Date.parse(this.get('created_at')));
      this.set("date_tz", this.formatDate(created_at_tz));
      this.set("name_tag", "<a href=https://twitter.com/" + this.get('screen_name') + ">" + this.get('name') + "</a>");
      return this.set("screen_name_tag", "<a href=https://twitter.com/" + this.get('screen_name') + "> (@" + this.get('screen_name') + ")</a>");
    };

    Tweet.prototype.formatDate = function(dt) {
      var dtToStr, monthNames;
...
(function() {
  ...
  StockDashboard.Models.User = (function(_super) {
...
(function() {
  ...
  StockDashboard.Collections.Dashboards = (function(_super) {
    __extends(Dashboards, _super);

    function Dashboards() {
      return Dashboards.__super__.constructor.apply(this, arguments);
    }

    Dashboards.prototype.model = StockDashboard.Models.Dashboard;
...
(function() {
  ...
  StockDashboard.Collections.Stocks = (function(_super) {
    __extends(Stocks, _super);

    function Stocks() {
      return Stocks.__super__.constructor.apply(this, arguments);
    }

    Stocks.prototype.model = StockDashboard.Models.Stock;
...
(function() {
  ...
  StockDashboard.Collections.Tweets = (function(_super) {
    ...
    Tweets.prototype.model = StockDashboard.Models.Tweet;

    Tweets.prototype.initialize = function() {
      this.symbol = "$" + $('#stockSymbolTxt').val();
    ...
    Tweets.prototype.updateCollection = function(collection) {
      return this.trigger('collectionUpdatedEvent');
    };
...
(function() {
  ...
  StockDashboard.Views.DashboardsIndex = (function(_super) {
    __extends(DashboardsIndex, _super);

    function DashboardsIndex() {
      return DashboardsIndex.__super__.constructor.apply(this, arguments);
    }

    DashboardsIndex.prototype.template = JST['dashboards/index'];

    DashboardsIndex.prototype.events = {
      'click #signOut': 'signOutTwitter',
      'click #searchBtn': 'searchStockInfo',
      'keypress #stockSymbolTxt': 'keyPressedStockTxt'
    };

    DashboardsIndex.prototype.initialize = function() {
      return this.symbol = "";
    };

    DashboardsIndex.prototype.render = function() {
      $(this.el).html(this.template());
      return this;
    };

    DashboardsIndex.prototype.signOutTwitter = function(event) {
      return this.render();
    };

    DashboardsIndex.prototype.searchStockInfo = function(event) {
      var stockSymbolTxt;
      $('#error-panel').addClass('hidden');
      event.preventDefault();
      stockSymbolTxt = $('#stockSymbolTxt').val();
      if (stockSymbolTxt.length < 1 || stockSymbolTxt.length > 10) {
        this.invalidTicker(stockSymbolTxt);
      }
      if (stockSymbolTxt.length > 0 && stockSymbolTxt.length <= 10) {
        return this.show();
      }
    };

    DashboardsIndex.prototype.invalidTicker = function(ticker) {
      return this.raiseError(ticker.length < 1 ? "Ticker symbol can not be blank" : void 0, ticker.length > 4 ? this.raiseError("Ticker symbol does not exist") : void 0);
    };

    DashboardsIndex.prototype.keyPressedStockTxt = function(event) {
      $('#error-panel').addClass('hidden');
      if (event.keyCode === 13) {
        return this.searchStockInfo(event);
      }
    };

    DashboardsIndex.prototype.show = function() {
      var error, newModel, that;
      that = this;
      try {
        newModel = new StockDashboard.Models.Stock();
        return newModel.fetch({
          success: function(model, response, options) {
            var isInvalid;
            isInvalid = response.query.results.quote.ErrorIndicationreturnedforsymbolchangedinvalid;
            if (isInvalid != null) {
              that.raiseError("No such ticker symbol");
            }
            if (isInvalid == null) {
              return that.updateView(model, response, options);
            }
          }
        });
      } catch (_error) {
    ...
    DashboardsIndex.prototype.raiseError = function(error_message) {
      $('#error-panel').removeClass('hidden');
      $('#error-panel').find("span").remove();
      $('#error-panel').append("<span>" + error_message + "</span>");
      if ($('#stockSymbolTxt').length > 0) {
        return $('#stockSymbolTxt').select();
      }
    };

    DashboardsIndex.prototype.updateView = function(model, response, options) {
      this.tweets = new StockDashboard.Collections.Tweets();
      if (this.model != null) {
        this.model.destroy();
      }
      if (this.view != null) {
      ...
      this.model = model;
      this.listenTo(this.model, 'updateTweetsEvent', this.updateTweets);
      this.model.updateAttributes(response);
      this.view = new StockDashboard.Views.Stock({
        model: model
      });
      return $('#left-panel').append(this.view.render().el);
    };

    DashboardsIndex.prototype.updateTweets = function(model) {
      if (this.tweets.length > 0) {
        this.updateTweetsView();
      }
      if (this.tweets.length === 0) {
        return this.resetTweetsView();
      }
    };

    DashboardsIndex.prototype.updateTweetsView = function() {
      var that;
      that = this;
      return this.tweets.fetch({
        success: function(collection, response, options) {
          return that.tweets.updateCollection(that.tweets);
        }
      });
    };

    DashboardsIndex.prototype.resetTweetsView = function() {
      var that;
      that = this;
      $('#right-panel').removeClass('hidden');
      if (this.twtsView != null) {
        this.twtsView.remove();
      }
      return this.tweets.fetch({
        success: function(collection, response, options) {
          that.twtsView = new StockDashboard.Views.Tweets({
            collection: that.tweets
          });
          return $('#tweets').append(that.twtsView.render().el);
        }
      });
    };
...
(function() {
  ...
  StockDashboard.Views.Stock = (function(_super) {
    __extends(Stock, _super);
    ...
    Stock.prototype.template = JST['dashboards/stock'];

    Stock.prototype.initialize = function() {
      var mdl, that;
      this.collection = new StockDashboard.Collections.Tweets();
      this.listenTo(this.model, 'destroy', this.unbindTimer);
      that = this;
      mdl = this.model;
    ...
    Stock.prototype.unbindTimer = function() {
...
(function() {
  ...
  StockDashboard.Views.Tweets = (function(_super) {
    __extends(Tweets, _super);
    ...
    Tweets.prototype.template = JST['dashboards/tweets'];

    Tweets.prototype.initialize = function() {
      return this.listenTo(this.collection, 'collectionUpdatedEvent', this.updateView);
    };
    ...
    Tweets.prototype.updateView = function() {
      return this.render();
    };
...
(function() {
  ...
  StockDashboard.Routers.Dashboards = (function(_super) {
    __extends(Dashboards, _super);
    ...
    Dashboards.prototype.routes = {
      '': 'index'
    };

    Dashboards.prototype.initialize = function() {};

    Dashboards.prototype.index = function() {
      var view;
      view = new StockDashboard.Views.DashboardsIndex();
      $('#container').html(view.render().el);
      return $("#stockSymbolTxt").focus();
    };

    Dashboards.prototype.dashboard = function() {};
